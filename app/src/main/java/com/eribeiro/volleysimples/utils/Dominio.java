package com.eribeiro.volleysimples.utils;

/**
 * Está classe contém as URLs de onde os dados via JSON serão estraidos.
 */
public class Dominio {
	public static final String URL_JSON_OBJECT = "http://api.androidhive.info/volley/person_object.json";
	public static final String URL_JSON_OBJECT_LOCAL = "http://192.168.1.134/PACE/index.php";
